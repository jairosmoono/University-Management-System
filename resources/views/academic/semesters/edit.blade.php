@extends('layouts.app')
@section('title', 'Edit Semester/Term')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1">Edit Semester/Term</h4>
        ...
        <form action="{{ route('academic.semesters.update', $semester) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="status" class="form-select">
                    ...
                    <option value="{{ $s }}" {{ old('status', $semester->status) === $s ? 'selected' : '' }}>{{ ucfirst($s) }}</option>
                    @endforeach
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">Update Semester/Term</button>
