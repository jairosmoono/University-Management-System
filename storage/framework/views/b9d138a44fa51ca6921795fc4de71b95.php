...
<head>
    ...
    <title>Apply Now — <?php echo e($uni['university_name'] ?? config('app.name')); ?></title>
...
<div class="topbar">
    <div class="container d-flex align-items-center justify-content-between gap-3">
        <a href="<?php echo e(route('home')); ?>" class="d-flex align-items-center gap-2 text-decoration-none">
            ...
            <?php endif; ?>
            <div>
                <div class="brand-name"><?php echo e($uni['university_name'] ?? config('app.name')); ?></div>
                <div class="brand-tag">Online Admissions Portal</div>
            </div>
        </a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-outline-light rounded-pill px-3">
...
<div class="container py-4" style="max-width:780px">
    ...
    <form method="POST" action="<?php echo e(route('apply.submit')); ?>" enctype="multipart/form-data" id="applyForm" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div class="form-section active" id="section-1">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="first_name" class="form-control" value="<?php echo e(old('first_name')); ?>" placeholder="e.g. Jane" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Middle Name</label>
                    <input type="text" name="middle_name" class="form-control" value="<?php echo e(old('middle_name')); ?>" placeholder="Optional">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Last Name <span class="required-star">*</span></label>
                    <input type="text" name="last_name" class="form-control" value="<?php echo e(old('last_name')); ?>" placeholder="e.g. Mwangi" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="nationality" class="form-control" value="<?php echo e(old('nationality', $uni['university_country'] ?? '')); ?>" placeholder="e.g. Zambian">
                </div>
            </div>
        </div>
        ...
        <div class="form-section" id="section-2">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>" placeholder="+260 97 000 0000" required>
                </div>
                <div class="col-12">
                    <label class="form-label">Residential Address</label>
                    <textarea name="address" class="form-control" rows="2" placeholder="Street, City, Province"><?php echo e(old('address')); ?></textarea>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="program_id" id="programSelect" class="form-select" required>
                        ...
                        <option value="<?php echo e($program->id); ?>"
                                data-faculty="<?php echo e($program->department?->faculty?->id); ?>"
                                <?php echo e(old('program_id') == $program->id ? 'selected' : ''); ?>>
        ...
        <div class="form-section" id="section-4">
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" name="previous_school" class="form-control" value="<?php echo e(old('previous_school')); ?>" placeholder="Name of your last school or institution" required>
                </div>
                <div class="col-md-6">
                    ...
                    <select name="qualification_type" class="form-select" required>
                        ...
                        <?php $__currentLoopData = ['Grade 12 Certificate','IGCSE','A-Level','Diploma','Advanced Diploma','Bachelor\'s Degree','Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($q); ?>" <?php echo e(old('qualification_type') == $q ? 'selected' : ''); ?>><?php echo e($q); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Year Completed <span class="required-star">*</span></label>
                    <input type="number" name="year_completed" class="form-control" value="<?php echo e(old('year_completed')); ?>"
                           min="1990" max="<?php echo e(date('Y')); ?>" placeholder="<?php echo e(date('Y') - 1); ?>" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label">Grade / GPA <span class="required-star">*</span></label>
                    <input type="text" name="grade" class="form-control" value="<?php echo e(old('grade')); ?>" placeholder="e.g. A, Merit, 3.8" required>
                </div>
            </div>
        </div>
        ...
        <div class="form-section" id="section-5">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <label class="form-label"><?php echo e($doc['label']); ?></label>
                    <label class="upload-zone d-block" id="zone-<?php echo e($doc['key']); ?>" for="file-<?php echo e($doc['key']); ?>">
                        <i class="bi <?php echo e($doc['icon']); ?> d-block mb-2"></i>
                        <div class="fw-semibold small" style="color:#374151" id="zone-text-<?php echo e($doc['key']); ?>">Click to upload</div>
                        <div class="text-muted" style="font-size:.75rem"><?php echo e(strtoupper(str_replace(['.','jpeg'], ['','JPG'], $doc['accept']))); ?></div>
                        <input type="file" id="file-<?php echo e($doc['key']); ?>" name="documents[<?php echo e($doc['key']); ?>]"
                               accept="<?php echo e($doc['accept']); ?>" class="d-none"
                               onchange="markUploaded('<?php echo e($doc['key']); ?>', this)">
                    </label>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
?>
const programs = <?php echo $programsJson; ?>;
...
<?php /**PATH C:\xampp\htdocs\college_management_system\resources\views/admissions/public_apply.blade.php ENDPATH**/ ?>