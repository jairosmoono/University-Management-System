...
<head>
    ...
    <title><?php echo e($uni['university_name'] ?? config('app.name')); ?> — Excellence in Education</title>
    <?php if(!empty($uni['favicon_path'])): ?>
    <link rel="icon" href="<?php echo e(asset('storage/' . $uni['favicon_path'])); ?>" type="image/x-icon">
    <?php endif; ?>
...
<nav id="mainNav" class="navbar navbar-expand-lg fixed-top py-2">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('home')); ?>">
            <?php if(!empty($uni['logo_path'])): ?>
            <img src="<?php echo e(asset('storage/' . $uni['logo_path'])); ?>" alt="Logo"
            ...
            <?php endif; ?>
            <div>
                <span class="brand-uni"><?php echo e($uni['university_name'] ?? config('app.name')); ?></span>
                <span class="brand-tag"><?php echo e($uni['university_short_name'] ?? ''); ?></span>
            </div>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            ...
            <div class="d-flex gap-2 mt-2 mt-lg-0">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-link-custom btn-nav-login">
                    <i class="bi bi-speedometer2 me-1"></i>Dashboard
                </a>
                <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-link nav-link-custom">Sign In</a>
                <a href="<?php echo e(route('apply')); ?>" class="nav-link btn-nav-login">Apply Now</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<section id="hero">
    ...
    <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="hero-bg-slide <?php echo e($slide['type'] === 'gradient' ? $slide['class'] : 'hero-slide-photo'); ?> <?php echo e($si === 0 ? 'active' : ''); ?>"
         <?php if($slide['type'] === 'photo'): ?> style="background-image:url('<?php echo e($slide['url']); ?>')" <?php endif; ?>>
        <?php if($slide['type'] === 'gradient'): ?>
        <div class="slide-orb">
            <div class="slide-orb-ring"></div>
            <div class="slide-orb-ring"></div>
            <div class="slide-orb-ring"></div>
            <div class="slide-orb-inner">
                <i class="bi <?php echo e($slide['icon']); ?> slide-orb-icon"></i>
            </div>
        </div>
        <?php endif; ?>
    </div>
            ...
            <div class="row">
                <div class="col-lg-7 py-5">
                    ...
                    <h1 class="hero-title mb-4">
                        ...
                        <span class="accent"><?php echo e($uni['university_name'] ?? config('app.name')); ?></span>
                    </h1>
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="<?php echo e(route('apply')); ?>" class="btn-hero-primary">
    ...
    <div id="heroDots">
        <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button class="hero-dot <?php echo e($si === 0 ? 'active' : ''); ?>" data-slide="<?php echo e($si); ?>" aria-label="Slide <?php echo e($si+1); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div class="container">
        <div class="row g-0 text-center">
            <div class="col-6 col-md-3 stat-item py-3">
                <div class="stat-num" data-count="<?php echo e($stats['students']); ?>">0</div>
                <div class="stat-label">Students</div>
            </div>
            <div class="col-6 col-md-3 stat-item py-3">
                <div class="stat-num" data-count="<?php echo e($stats['programs']); ?>">0</div>
                <div class="stat-label">Programmes</div>
            </div>
            <div class="col-6 col-md-3 stat-item py-3">
                <div class="stat-num" data-count="<?php echo e($stats['departments']); ?>">0</div>
                <div class="stat-label">Departments</div>
            </div>
            <div class="col-6 col-md-3 stat-item py-3">
                <div class="stat-num" data-count="<?php echo e($stats['courses']); ?>">0</div>
            ...
            <div class="col-lg-6">
                <div class="about-card-big mb-4">
                    ...
                    <p style="color:rgba(255,255,255,.72);line-height:1.75;margin-bottom:1.5rem">
                        Founded over six years ago, <?php echo e($uni['university_name'] ?? config('app.name')); ?> has grown into
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="about-feature">
                        ...
                        <div>
                            <div class="fw-bold mb-1" style="font-size:.95rem"><?php echo e($feat['title']); ?></div>
                            <div class="text-muted small"><?php echo e($feat['desc']); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="section-sub mx-auto">
                <?php echo e($faculties->count()); ?> distinct faculties under one roof.
            </p>
        </div>
        <?php
            $facultyColors = [
        ...
        ?>
        <div class="row g-4">
            <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-sm-6 col-lg-4">
                <div class="faculty-card card">
                    <div class="faculty-header" style="background:linear-gradient(135deg,<?php echo e($facultyColors[$i % count($facultyColors)]); ?>22,<?php echo e($facultyColors[$i % count($facultyColors)]); ?>08)">
                        <div class="faculty-icon" style="background:<?php echo e($facultyColors[$i % count($facultyColors)]); ?>">
                            <i class="bi <?php echo e($facultyIcons[$i % count($facultyIcons)]); ?>"></i>
                        </div>
                        <h5 class="fw-bold mb-1" style="font-size:1rem;color:var(--navy)"><?php echo e($faculty->name); ?></h5>
                        <div class="text-muted small"><?php echo e($faculty->departments_count); ?> <?php echo e(Str::plural('Department', $faculty->departments_count)); ?></div>
                    </div>
                    <div class="card-body py-2 px-3">
                        <ul class="list-unstyled mb-0">
                            <?php $__currentLoopData = $faculty->departments->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="py-1 border-bottom d-flex align-items-center gap-2 small text-muted">
                                <i class="bi bi-chevron-right" style="color:<?php echo e($facultyColors[$i % count($facultyColors)]); ?>;font-size:.7rem"></i>
                    ...
                    <div class="card-footer">
                        ...
                        <?php echo e($faculty->departments->sum(fn($d) => $d->programs->count())); ?> Programme(s) offered
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container">
        ...
        <div class="row align-items-end mb-4">
            <div class="col-lg-7">
                ...
                <div class="divider-gold"></div>
                <p class="section-sub">
                    We offer <?php echo e($programs->count()); ?> accredited programme<?php echo e($programs->count() !== 1 ? 's' : ''); ?> designed for the modern world.
                </p>
            </div>
            <?php if($availableLevels->isNotEmpty()): ?>
            <div class="col-lg-5 text-lg-end mt-3 mt-lg-0">
                <div class="d-flex gap-2 flex-wrap justify-content-lg-end">
                    ...
                    <span class="program-level level-<?php echo e($lvl); ?>"><?php echo e($levelLabels[$lvl] ?? ucfirst($lvl)); ?></span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <?php endif; ?>
                ...
                <div class="program-card">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <span class="program-level level-<?php echo e($program->level); ?>">
                            <?php echo e($levelLabels[$program->level] ?? ucfirst($program->level ?? '')); ?>

                        </span>
                        <?php if($program->code): ?>
                        <span class="text-muted" style="font-size:.75rem;font-weight:600;letter-spacing:.05em"><?php echo e($program->code); ?></span>
                        <?php else: ?>
                        <i class="bi bi-arrow-up-right-circle text-muted"></i>
                        <?php endif; ?>
                    </div>
                    <h6 class="fw-bold mb-1" style="color:var(--navy);font-size:.97rem"><?php echo e($program->name); ?></h6>
                    <div class="text-muted small mb-2"><?php echo e($program->department?->name); ?></div>
                    <div class="d-flex align-items-center justify-content-between mt-3">
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-building-fill text-muted" style="font-size:.75rem"></i>
                            <span class="text-muted" style="font-size:.78rem"><?php echo e($program->department?->faculty?->name); ?></span>
                        </div>
                        <?php if($program->duration_years): ?>
                        <span class="text-muted" style="font-size:.75rem">
                            <i class="bi bi-clock me-1"></i><?php echo e($program->duration_label); ?>
        ...
        <div class="text-center mt-5 d-flex gap-3 justify-content-center flex-wrap">
            <a href="<?php echo e(route('programs')); ?>" class="btn btn-lg fw-bold px-5 py-3"
               style="background:var(--navy);color:#fff;border-radius:50px">
                <i class="bi bi-grid-3x3-gap me-2"></i>View All Programmes
            </a>
            <?php if(auth()->guard()->guest()): ?>
            <a href="<?php echo e(route('apply')); ?>" class="btn btn-lg fw-bold px-5 py-3"
...
<section id="why" style="padding:80px 0">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="why-card">
                    <div class="why-icon"><i class="bi <?php echo e($item['icon']); ?>"></i></div>
    ...
    <div class="container">
        <div class="row align-items-end mb-5">
            ...
            <div class="col-lg-4 text-center text-lg-end mt-3 mt-lg-0">
                <a href="<?php echo e(route('news.public')); ?>"
        ...
        ?>
        <script>const annAttachMap = <?php echo json_encode($annAttachMap, 15, 512) ?>;</script>

        <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php if($i === 0): ?><div class="row g-4"><?php endif; ?>
            <?php
            ...
            <div class="col-md-4">
                <div class="news-card card h-100">
                    <div class="news-thumb" style="background:linear-gradient(135deg,<?php echo e($bgFrom); ?>,<?php echo e($bgTo); ?>)">
                        <i class="bi <?php echo e($catIcon); ?> text-white" style="font-size:2.5rem;opacity:.45"></i>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                            <span class="news-date">
                                <i class="bi bi-calendar3 me-1"></i><?php echo e($ann->created_at->format('d M Y')); ?>
                        ...
                        <h6 class="fw-bold mb-2" style="color:var(--navy)"><?php echo e($ann->title); ?></h6>
                        <p class="text-muted small mb-0" style="line-height:1.6">
                            <?php echo e(Str::limit(strip_tags($ann->content ?? ''), 120)); ?>

                        </p>
                    </div>
                    <div class="card-footer bg-white border-0 pb-3 pt-0 px-4">
                        <?php $hasAttach = !empty($ann->attachments); ?>
                        <div class="d-flex align-items-center justify-content-between">
                            <button type="button"
                                class="btn btn-link p-0 small fw-semibold text-decoration-none ann-read-more"
                                style="color:var(--gold)"
                                data-ann-id="<?php echo e($ann->id); ?>"
                                data-title="<?php echo e(e($ann->title)); ?>"
                                data-date="<?php echo e($ann->created_at->format('d F Y')); ?>"
                                data-category="<?php echo e(e($ann->category ?? '')); ?>"
                                data-content="<?php echo e(e($ann->content ?? '')); ?>"
                                data-bg-from="<?php echo e($bgFrom); ?>"
                                data-bg-to="<?php echo e($bgTo); ?>"
                                data-icon="<?php echo e($catIcon); ?>">
                                Read more <i class="bi bi-arrow-right ms-1"></i>
                            </button>
                            <?php if($hasAttach): ?>
                            <span title="<?php echo e(count($ann->attachments)); ?> attachment(s)"
                                  style="font-size:.75rem;color:#6b7280;display:flex;align-items:center;gap:.25rem">
                                <i class="bi bi-paperclip"></i><?php echo e(count($ann->attachments)); ?>
    ...
    <div class="container">
        <div class="row align-items-end mb-5">
            ...
            <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                <a href="<?php echo e(route('jobs.public')); ?>"
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="job-card">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <span class="job-type-badge <?php echo e($typeClass); ?>"><?php echo e($typeLabel); ?></span>
                        <?php if($job->deadline): ?>
                        <span style="font-size:.75rem;color:<?php echo e($job->deadline->isPast() ? '#f87171' : 'rgba(255,255,255,.5)'); ?>">
                            <i class="bi bi-calendar-x me-1"></i><?php echo e($job->deadline->format('d M Y')); ?>

                        </span>
                        <?php endif; ?>
                    </div>
                    <h6 style="color:#fff;font-weight:700;font-size:1rem;margin-bottom:.4rem;line-height:1.35"><?php echo e($job->title); ?></h6>
                    <div style="color:rgba(255,255,255,.5);font-size:.82rem;margin-bottom:.75rem">
                        <i class="bi bi-diagram-3 me-1"></i><?php echo e($job->department?->name ?? 'General'); ?>

                    </div>
                    <?php if($job->description): ?>
                    <p style="color:rgba(255,255,255,.55);font-size:.85rem;line-height:1.6;flex:1">
                        <?php echo e(Str::limit(strip_tags($job->description), 110)); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3 pt-3" style="border-top:1px solid rgba(255,255,255,.08)">
                        <span style="color:rgba(255,255,255,.45);font-size:.8rem">
                            <i class="bi bi-person-plus me-1"></i><?php echo e($job->vacancies); ?> <?php echo e(Str::plural('vacancy', $job->vacancies)); ?>

                        </span>
                        <a href="<?php echo e(route('jobs.public')); ?>#job-<?php echo e($job->id); ?>"
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                <p style="color:var(--navy);opacity:.75;font-size:1.05rem;max-width:480px;margin:0 auto 2rem;line-height:1.7">
                    ...
                    any descipline from <?php echo e($uni['university_name'] ?? config('app.name')); ?>.
                </p>
        ...
        <div class="row g-5 pb-5">
            ...
            <div class="col-lg-4">
                <div class="footer-logo d-flex align-items-center gap-2 mb-3">
                    ...
                    <?php endif; ?>
                    <div>
                        <span class="f-name d-block"><?php echo e($uni['university_name'] ?? config('app.name')); ?></span>
                ...
                <p style="color:rgba(255,255,255,.5);font-size:.88rem;line-height:1.75;margin-bottom:1.5rem">
                    ...
                    <?php if(!empty($uni['university_website'])): ?>
                    <a href="<?php echo e($uni['university_website']); ?>" target="_blank" style="color:var(--gold)"><?php echo e($uni['university_website']); ?></a>
                    <?php endif; ?>
                </p>
                <div class="d-flex gap-2">
                    <?php $__currentLoopData = ['facebook','twitter-x','linkedin','youtube','instagram']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#" class="social-btn"><i class="bi bi-<?php echo e($soc); ?>"></i></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-2">
                ...
                <?php $__currentLoopData = $faculties->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="#academics" class="footer-link"><?php echo e(Str::limit($fac->name, 28)); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    ?>
                    <?php $__currentLoopData = $contactItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex gap-3 align-items-start">
                        <div style="width:32px;height:32px;border-radius:8px;background:rgba(201,168,76,.15);display:flex;align-items:center;justify-content:center;flex-shrink:0">
                            <i class="bi <?php echo e($ct['icon']); ?>" style="color:var(--gold);font-size:.85rem"></i>
                        </div>
                        <span style="color:rgba(255,255,255,.55);font-size:.88rem;line-height:1.5"><?php echo e($ct['text']); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                    <span style="color:rgba(255,255,255,.35);font-size:.82rem">
                        &copy; <?php echo e(date('Y')); ?> <?php echo e($uni['university_name'] ?? config('app.name')); ?>. All rights reserved.
                    </span>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="footer-link d-inline" style="font-size:.8rem">Staff Portal</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\college_management_system\resources\views/landing.blade.php ENDPATH**/ ?>