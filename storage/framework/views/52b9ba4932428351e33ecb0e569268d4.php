...
<head>
    <meta charset="UTF-8">
    <title>Seating Plan — <?php echo e($examination->name); ?></title>
    <style>
    ...
    <tr>
        <td style="width:65%">
            ...
            <span class="org-sub" style="padding-left:48px">
                <?php if($uniAddr): ?><?php echo e($uniAddr); ?><?php endif; ?>
                <?php if($uniAddr && ($uniPhone || $uniEmail)): ?> &bull; <?php endif; ?>
                <?php if($uniPhone): ?><?php echo e($uniPhone); ?><?php endif; ?>
                <?php if($uniPhone && $uniEmail): ?> | <?php endif; ?>
                <?php if($uniEmail): ?><?php echo e($uniEmail); ?><?php endif; ?>
            </span>
        </td>
        <td style="text-align:right;vertical-align:middle">
            <div class="doc-meta">SEATING PLAN</div>
            <div class="doc-title"><?php echo e($examination->name); ?></div>
...
<table style="border-collapse:collapse;margin-bottom:14px">
    <tr>
        <td style="<?php echo e($pillLbl); ?>">EXAMINATION</td>
        <td style="<?php echo e($pillVal); ?>"><?php echo e($examName); ?></td>
        <td style="width:12px"></td>
        <td style="<?php echo e($pillLbl); ?>">DATE</td>
        <td style="<?php echo e($pillVal); ?>"><?php echo e($examDate); ?></td>
        <td style="width:12px"></td>
        <td style="<?php echo e($pillLbl); ?>">CANDIDATES</td>
        <td style="<?php echo e($pillVal); ?>"><?php echo e($students->count()); ?></td>
    </tr>
</table>
...
<?php else: ?>
<?php $seatNo = 1; ?>
<?php $__currentLoopData = $byProgram; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programName => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<table style="width:100%;border-collapse:collapse;margin-bottom:4px;margin-top:10px">
    <tr>
        ...
        <td style="background:#C9A84C;color:#0B1F3A;padding:5px 8px;font-size:9px;text-align:right;white-space:nowrap;font-weight:bold">
            <?php echo e($group->count()); ?> candidate(s)
        </td>
    </tr>
</table>
...
<table class="seats">
    ...
    <tbody>
        ...
        <tr>
            <td class="seat-no"><?php echo e(str_pad($seatNo++, 2, '0', STR_PAD_LEFT)); ?></td>
            <td class="student-id"><?php echo e($student->student_id); ?></td>
            <td style="font-weight:600"><?php echo e(optional($student->user)->name ?? '—'); ?></td>
            <td></td>
        </tr>
...
<table class="sigs">
    <tr>
        <td style="width:33%">
            <div class="sig-line">Invigilator: <?php echo e($invigilator); ?></div>
        </td>
        <td style="width:33%">
...
<table class="foot">
    <tr>
        <td>Confidential &mdash; For Official Use Only &mdash; <?php echo e($uniName); ?></td>
        <td class="r">Seating Plan &mdash; <?php echo e($examination->name); ?> &mdash; <?php echo e(now()->format('d M Y')); ?></td>
    </tr>
</table>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\college_management_system\resources\views/academic/examinations/seating.blade.php ENDPATH**/ ?>